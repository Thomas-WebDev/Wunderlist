...
fs.readFile("./Wunderlist/Wunderlist/membership-344028669.json", "utf8", function(err, data) {
    if(!err) {
        ...
        for(var i = 0; i < jsonListDataValuesLength; i++) {
            ...
            var list_id = jsonListData[i].list_id
            //console.log("LIST ID: " + list_id)
            fs.readFile("./Wunderlist/Wunderlist/task-"+list_id+".json", "utf8", function(err, data) {
                if(!err) {
            ...
            fs.readFile("./Wunderlist/Wunderlist/task_position-"+list_id+".json", "utf8", function(err, data) {
                if(!err) {
                    ...
                    var task_positionLength = task_position[0].values.length

                    for(var j = 0; j < task_positionLength; j++) {
                        var task_positionValues = task_position[0].values[j]
                        //console.log("LIST ID: " + list_id + " task_positionValues: " + task_positionValues)
                        fs.readFile("./Wunderlist/Wunderlist/note-"+task_positionValues+".json", "utf8", function(err, data) {
                            if(!err) {
                        ...
                        fs.readFile("./Wunderlist/Wunderlist/task_comment-"+task_positionValues+".json", "utf8", function(err, data) {
                            if(!err) {
                                var task_comment = JSON.parse(data)
                                var task_commentLength = task_position.length
                        ...
                        fs.readFile("./Wunderlist/Wunderlist/task_comment_state-"+task_positionValues+".json", "utf8", function(err, data) {
                            if(!err) {
                        ...
                        fs.readFile("./Wunderlist/Wunderlist/subtask_position-"+task_positionValues+".json", "utf8", function(err, data) {
                            if(!err) {
                                ...
                                var subtaskpositionLength = subtask_position[0].values.length
                                /*for(var n = 0; n < subtaskpositionLength; n++) {
                                    fs.readFile("./Wunderlist/Wunderlist/subtask-"+task_positionValues+".json", "utf8", function(err, data) {
                                        if(!err) {
                                            ...
                                            for(var n = 0; n < subtask.length; n++) {
                                                ...
                                                if(subtaskpositionvalues.contains(subtaskid)){
                                                    //return the subtask
                                                }
                                            }
                                        } else {
                                            console.log("subtask error")
                                        }
                                    });
                                }*/
                            }
